            ...
            <div class="mt-10">
                <div id="bar-with-underline-1" role="tabpanel" aria-labelledby="bar-with-underline-item-1">
                    <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                        <form @submit.prevent="uploadMedicalLicense">
                            ...
                            <div class="grid md:grid-cols-1 sm:grid-cols-12 gap-4 p-4 md:p-5">
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Documento Firmado</label>
...
export default {
    ...
    methods: {
        ...
        uploadMedicalLicense() {
            ...
            formData.append('medical_license_id', this.$route.params.id);
            ...
            axios.post('https://apijis.com/medical_licenses/upload', formData, {
                headers: {
