...
export default {
    ...
    methods: {
        ...
        async downloadMedicalLicense(id) {
            ...
            try {
                const response = await axios.get('https://apijis.com/medical_licenses/download/' + id, {
                    headers: {
        ...
        async getMedicalLicenses() {
            ...
            try {
                const response = await axios.get('https://apijis.com/medical_licenses/edit/' + this.$route.params.rut + '/' + page, {
                    headers: {
                    accept: 'application/json',
                    Authorization: `Bearer ${accessToken}` // Agregar el token al encabezado de la solicitud
                    },
        ...
        async deleteMedicalLicense(id) {
            ...
            try {
                const accessToken = localStorage.getItem('accessToken');
                await axios.delete(`https://apijis.com/medical_licenses/delete/${id}`, {
                    headers: {
                        accept: 'application/json',
