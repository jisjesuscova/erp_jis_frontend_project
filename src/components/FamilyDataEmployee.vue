                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead class="bg-gray-50 dark:bg-gray-700">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Fecha de Nacimiento</th>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700" >
                                    <tr v-for="family in families" :key="family.id">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ formatDate(family.born_date) }}</td>
...
export default {
    ...
    methods: {
        async getFamilies() {
            ...
            try {
                const response = await axios.get('https://apijis.com/family_core_data/edit/' + this.$route.params.rut + '/2', {
                    headers: {
        ...
        async deleteFamily(id) {
            try {
                const accessToken = localStorage.getItem('accessToken');
                await axios.delete(`https://apijis.com/family_core_data/delete/${id}`, {
                    headers: {
                        accept: 'application/json',
