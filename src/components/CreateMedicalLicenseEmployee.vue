                    ...
                    <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                        <form @submit.prevent="createMedicalLicense">
                            ...
                            <div class="grid md:grid-cols-3 sm:grid-cols-12 gap-4 p-4 md:p-5">
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Folio</label>
                                    <input
                                        type="text"
                                        id="email_input"
                                ...
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Tipo de Patología</label>
                                    <select required v-model="patology_type_input" class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="">- Tipo de Patología -</option>
                                        <option v-for="patology_type in patology_types" :key="patology_type.id" :value="patology_type.id">{{ patology_type.patology_type }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="grid md:grid-cols-3 sm:grid-cols-12 gap-4 p-4 md:p-5">
                            ...
                            <div class="grid md:grid-cols-8 sm:grid-cols-12 gap-4 p-4 md:p-5">
                                ...
                                <router-link
                                    :to="`/medical_license_data_employee/${$route.params.rut}`"
...
export default {
    ...
    methods: {
        ...
        createMedicalLicense() {
            ...
            axios.post('https://apijis.com/medical_licenses/store', formData, {
                headers: {
                ...
                this.$router.push('/medical_license_data_employee/' + this.$route.params.rut);
            }).catch(error => {
                console.error(error);
                this.loading = false;
            });
