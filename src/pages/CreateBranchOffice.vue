<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Ingresar Sucursal</h2>

            <div class="mt-3">
                <div v-if="validate_create_branch_office == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    Sucursal Ingresada con <span class="font-bold">éxito</span> 
                </div>
                <div
                ...
                >
                    ...
                    >
                        <form @submit.prevent="createBranchOffice">
                            <div
...
export default {
    ...
    data() {
        return {
            ...
            loading_4: false,
            loading_5: false,
            validate_create_branch_office: 0,
            zone_input: 0,
            regions: [],
            communes: [],
            segments: [],
    ...
    methods: {
        ...
        async createBranchOffice() {
            try{
                ...
                const accessToken = localStorage.getItem('accessToken')
                await axios.post('https://apijis.combranch_offices/store/', dataToSend, 
                {
                    headers: {
                                accept: 'application/json',
                                Authorization: `Bearer ${accessToken}`, // Agregar el token al encabezado de la solicitud
            ...
            this.validate_create_branch_office = 1
