<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Ingresar Segmento</h2>

            <div class="mt-3">
                <div v-if="validate_create_segment == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    Segmento Ingresado con <span class="font-bold">éxito</span> 
                </div>
                <div
    ...
    methods: {
        async createSegment() {
            try{
                ...
                await axios.post('http://localhost:8000/segments/store/', dataToSend, 
                {
                    headers: {
            ...
            this.validate_create_segment = 1
            this.segment_name_input = ''
