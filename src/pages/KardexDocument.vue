...
export default {
    ...
    methods: {
        ...
        async downloadKardex(id) {
            ...
            try {
                const response = await axios.get('https://apijis.com/kardex_data/download/' + id, {
                    headers: {
        ...
        async getKardexData() {
            ...
            try {
                const response = await axios.get('https://apijis.com/kardex_data/edit/' + this.$route.params.rut, {
                    headers: {
                    accept: 'application/json',
                    Authorization: `Bearer ${accessToken}` // Agregar el token al encabezado de la solicitud
                    },
        ...
        async deleteKardex(id) {
            ...
            try {
                const accessToken = localStorage.getItem('accessToken');
                await axios.delete(`https://apijis.com/kardex_data/delete/${id}`, {
                    headers: {
                        accept: 'application/json',
