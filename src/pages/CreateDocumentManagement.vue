                            ...
                            >
                                <div>
                                    <label
                                        ...
                                        >¿Qué documento va a solicitar?</label
                                    >
                                    <select
                                    ...
                                    >
                                        ...
                                        <option
                                            v-for="document_type in filteredDocumentTypes"
...
export default {
        ...
        async getDocumentTypes() {
            ...
            try {
                const response = await axios.get(
                    'https://apijis.comdocument_types/2',
                    {
                        headers: {
    ...
    computed: {
        filteredDocumentTypes() {
            return this.document_types.filter(
                (document_type) => document_type.id === 4,
            )
        },
    },
}
