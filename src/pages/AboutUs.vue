<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Sobre Nosotros</h2>

            <div class="mt-3">
                <div v-if="validate_update_about_us == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    Mensaje de nosotros actualizado con <span class="font-bold">éxito</span> 
                </div>
                <div
...
export default {
    ...
    methods: {
        async getAboutUS() {
            ...
            this.loading = false
            this.about_us_input = response.data.text
            }
            catch(error){
                console.log(error)
                this.loading = false
        ...
        async updateAboutUs() {
            ...
            this.validate_update_about_us = 1
