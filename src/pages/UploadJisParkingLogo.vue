<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Ingresar Logo</h2>

            <div class="mt-3">
                <div v-if="validate_upload_logo == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    Logo Ingresado con  <span class="font-bold">éxito</span> 
                </div>
                <div
                ...
                >
                    ...
                    >
                        <form @submit.prevent="uploadLogo">
                            ...
                            >
                            <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Logo</label>
