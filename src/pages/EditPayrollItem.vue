<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Actualizar Nomima</h2>

            <div class="mt-3">
                <div v-if="validate_update_payroll == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    Nomima Actualizada con <span class="font-bold">éxito</span> 
                </div>
                <div
                ...
                >
                    ...
                    >
                        <form @submit.prevent="updatePayrollItem">
                            <div
        ...
        async getPayrollItem() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/payroll_items/edit/' +
        ...
        async updatePayrollItem() {
            ...
            try {
                ...
                const response = await axios.patch(
                    'http://localhost:8000/payroll_items/update/' +
                        this.$route.params.id,
                    formData,
                    {
                        headers: {
                ...
                this.validate_update_payroll = 1
            } catch (error) {
                console.error(error)
            } finally {
                this.loading = false
