        ...
        <div v-else class="flex flex-col pt-10">
            ...
            <div class="mt-10">
                ...
                >
                    ...
                    <div
                        v-if="validate_cellphone_status == 1"
                        class="bg-red-500 text-sm text-white rounded-md p-4 mb-10 mt-10"
                        role="alert"
                    >
                        El celular ya está
                        <span class="font-bold">registrado </span> por
                        <span class="font-bold"> {{ fullNameRut }} </span>.
                    </div>
                    <div
                    ...
                    <div
                        ...
                        role="alert"
                        v-if="updated_personal_employee_data == 1"
                    >
                    ...
                    >
                        La ficha es
                        <span class="font-bold">solamente informátiva</span>. No
                            ...
                            >
                                <div>
                                    <label
                                        for="hs-validation-name-error"
                                        class="block text-sm font-medium mb-2 dark:text-white"
                                        >Rol en el Reloj</label
                                    >
                                    <select
                                        v-model="privilege_input"
                                        required
                                        class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    >
                    ...
                    <div
                        ...
                        role="alert"
                        v-if="
                            updated_employee_bank_account == 1 &&
                            status_bank_id == 1
                        "
                    >
                        Registro actualizado con
                    ...
                    <div
                        ...
                        role="alert"
                        v-if="
                            created_employee_bank_account == 1 &&
                            status_bank_id == 0
                        "
                    >
                ...
                >
                    <div>
                        <div
                            ...
                            role="alert"
                        >
                            <i class="fa-solid fa-circle-exclamation"></i> Es la
                            firma que se uilizará para los documentos.
                        </div>
                        <Vue3Signature
                            ref="signature1"
...
export default {
    ...
    methods: {
            ...
            if (this.signature1) {
                try {
                    ...
                    const response = await axios.post(
                        'https://apijis.comemployees/signature/',
                        formData,
                        {
                            headers: {
        ...
        async deletePicture() {
            ...
            try {
                const response = await axios.delete(
                    'https://apijis.comemployees/delete/picture/' +
        ...
        async deleteSignature() {
            ...
            try {
                const response = await axios.delete(
                    'https://apijis.comemployees/delete/signature/' +
                        this.$route.params.rut,
                    {
                        headers: {
                            accept: 'application/json',
        ...
        async updatePicture() {
            ...
            axios
                .post(
                    'https://apijis.comemployees/upload/picture',
                    formData,
                    {
                        headers: {
                            Authorization: `Bearer ${accessToken}`,
        ...
        createEmployeeBankAccount() {
            ...
            axios
                .post('https://apijis.comemployee_bank_accounts/store', dataToSend, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                        accept: 'application/json',
                    },
        ...
        async updateEmployeeBankAccount() {
            ...
            try {
                ...
                const response = await axios.patch(
                    'https://apijis.comemployee_bank_accounts/update/' +
                        this.$route.params.rut,
                    dataToSend,
                    {
                        headers: {
        ...
        async updatePersonalDataEmployee() {
            ...
            try {
                ...
                const response = await axios.patch(
                    'https://apijis.comemployees/update/' +
                        this.$route.params.rut,
                    dataToSend,
                    {
                        headers: {
            ...
            try {
                ...
                const response = await axios.patch(
                    'https://apijis.comclock_users/update/' +
                        this.$route.params.rut,
                    dataToSend,
                    {
                        headers: {
        ...
        validateRutExist() {
            ...
            axios
                .get('https://apijis.comemployees/validate_rut/' + rut[0], {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                        accept: 'application/json',
                    },
        ...
        async getPersonalDataEmployee() {
            ...
            try {
                const response = await axios.get(
                    'https://apijis.comemployees/edit/' +
                        this.$route.params.rut,
                    {
                        headers: {
                            accept: 'application/json',
                ...
                this.nationality_input =
                    decodedData.employee_data.nationality_id
        ...
        async getBankAccountEmployee() {
            ...
            try {
                const response = await axios.get(
                    'https://apijis.comemployee_bank_accounts/edit/' +
                        this.$route.params.rut,
                    {
                        headers: {
                            accept: 'application/json',
                ...
                if (
                    this.bank_input == '' &&
                    this.account_type_input == '' &&
                    this.account_number_input == ''
                ) {
