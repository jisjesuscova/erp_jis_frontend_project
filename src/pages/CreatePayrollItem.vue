<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Crear nomina</h2>

            <div class="mt-3">
                <div v-if="validate_create_payroll == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    nomina Creada con <span class="font-bold">éxito</span> 
                </div>
                <div
                ...
                >
                    ...
                    >
                        <form @submit.prevent="createPayrollItem">
                            <div
                            ...
                            >
                                <div>
                                    <label
                                        ...
                                        >Tipo de nomina</label
                                    >
                                    <select
                                        v-model="item_type_id_input"
                                        required
    ...
    methods: {
        async createPayrollItem() {
            try{
                ...
                await axios.post('http://localhost:8000/payroll_items/store/', dataToSend, 
                {
                    headers: {
            ...
            this.loading = false
            this.validate_create_payroll = 1
            this.item_type_id_input = 0
            this.item_input = ''
