<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Ingresar Principal</h2>

            <div class="mt-3">
                <div v-if="validate_create_principal == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    Principal Ingresado con <span class="font-bold">éxito</span> 
                </div>
                <div
                ...
                >
                    ...
                    >
                        <form @submit.prevent="createPrincipal">
                            <div
...
export default {
    ...
    data() {
        return {
            loading: false,
            loading_1: false,
            validate_create_principal: 0,
            principal_name_input: '',
        }
    },
    methods: {
        async createPrincipal() {
            try{
                ...
                this.loading_1 = true
                const dataToSend = {
                    principal : this.principal_name_input,
                    added_date : new Date(),
                    updated_date : new Date(),
                }
                console.log(dataToSend)
                const accessToken = localStorage.getItem('accessToken')
                await axios.post('http://localhost:8000/principals/store/', dataToSend, 
                {
                    headers: {
            ...
            this.validate_create_principal = 1
            this.principal_name_input = ''
