    ...
    methods: {
        ...
        async createEmployee() {
            ...
            try {
                ...
                const response = await axios.post('https://apijis.com/employees/store', dataToSend, {
                    headers: {
            ...
            try {
                ...
                const response = await axios.post('https://apijis.com/employee_extras/store', dataToSend, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                        accept: 'application/json',
                    },
            ...
            try {
                ...
                const response = await axios.post('https://apijis.com/employee_labor_data/store', dataToSend, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                        accept: 'application/json',
                    },
            ...
            try {
                ...
                const response = await axios.post('https://apijis.com/clock_users/store', dataToSend, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                        accept: 'application/json',
                    },
            ...
            try {
                ...
                const response = await axios.post('https://apijis.com/users/store', dataToSend, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`,
                        accept: 'application/json',
                    },
