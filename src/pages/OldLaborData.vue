...
export default {
    ...
    methods: {
        ...
        async generateContract() {
            ...
            const short_current_date = this.formatDateToCustomFormat(
                new Date(original_date),
            )

            const first_expiration = this.formatDateToCustomFormat(
                new Date(this.first_expiration),
            )

            const second_expiration = this.formatDateToCustomFormat(
                new Date(this.second_expiration),
            )

            if (
                this.employee_labor_data &&
                this.employee_labor_data.PentionModel
            ) {
                if (
                    this.employee_labor_data.PentionModel.pention === undefined
                ) {
            ...
            if (
                this.employee_labor_data.EmployeeLaborDatumModel
                    .employee_type_id == '1'
            ) {
                const docDefinition = {
                    content: [
                        ...
                        },
                        {
                            text: [
                                ...
                                'representada por don',
                                {
                                    text:
                                        ' ' +
                                        'MARCELO ALEJANDRO INZUNZA GONZÁLEZ',
                                    bold: true,
                                },
                                ...
                                'con domicilio en',
                                {
                                    text:
                                        ' ' +
                                        this.employee_labor_data
                                            .EmployeeLaborDatumModel.address +
                                        ', ',
                                    bold: true,
                                },
                                'perteneciente a la comuna',
                                {
                                    text:
                                        ' ' +
                                        this.employee_labor_data.CommuneModel
                                            .commune +
                                        ', ',
                                    bold: true,
                                },
                                {
                                    text:
                                        ' de ' +
                                        this.employee_labor_data.RegionModel
                                            .region +
                                        ', ',
                                    bold: true,
                                },
                                'de estado civil',
                                {
                                    text:
                                        ' de ' +
                                        this.employee_labor_data.CivilStateModel
                                            .civil_state +
                                        ', ',
                                    bold: true,
                                },
                                ...
                                ' El trabajador recibirá a título de remuneración un sueldo base bruto mensual de $',
                                {
                                    text:
                                        ' ' +
                                        this.employee_labor_data
                                            .EmployeeLaborDatumModel.salary +
                                        '.- ',
                                    bold: true,
                                },
                                ...
                                ', y a la institución de salud previsional:',
                                {
                                    text:
                                        ' ' +
                                        this.employee_labor_data.HealthModel
                                            .health +
                                        ', ',
                                    bold: true,
                                },
                        ...
                        },
                        {
                            text: [
                                ...
                                {
                                    text: 'MARCELO ALEJANDRO INZUNZA GONZÁLEZ',
                                    bold: true,
                                },
                                ', cédula nacional de identidad número',
                        ...
                        },
                        {
                            text: [
                                ...
                                ', se encuentra en conocimiento de los riesgos por exposición laboral a COVID-19 y las medidas que se debe tomar para evitar su contagio. Además, se solicita que se respeten las restantes normas de higiene y seguridad (Principalmente las indicaciones RIOHS) y participe activamente en las actividades de prevención.',
                            ],
                            fontSize: 9,
                            alignment: 'justify',
                            margin: [0, 0, 0, 40],
        ...
        async updateLaborData() {
            ...
            try {
                const response = await axios.patch(
                    'http://localhost:8000/employee_labor_data/update/' +
        ...
        async getEmployeeLaborData() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/old_employee_labor_data/edit/' +
                        this.$route.params.rut,
                    {
                        headers: {
                            accept: 'application/json',
        ...
        async getExpirations() {
            ...
            try {
                const response = await axios.post(
                    'http://localhost:8000/contract_data/expiration',
                    dataToSend,
                    {
                        headers: {
                            accept: 'application/json',
        ...
        async getEmployeeTypes() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/employee_types/',
                    {
                        headers: {
                            accept: 'application/json',
                            Authorization: `Bearer ${accessToken}`, // Agregar el token al encabezado de la solicitud
        ...
        async getContractTypes() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/contract_types/',
                    {
                        headers: {
                            accept: 'application/json',
                            Authorization: `Bearer ${accessToken}`, // Agregar el token al encabezado de la solicitud
        ...
        async getCivilStates() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/civil_states/',
                    {
                        headers: {
                            accept: 'application/json',
                            Authorization: `Bearer ${accessToken}`, // Agregar el token al encabezado de la solicitud
        ...
        async getEmployeeContracts() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/employee_contracts/edit/' +
                        this.$route.params.rut,
                    {
                        headers: {
                            accept: 'application/json',
        ...
        async getPersonalDataEmployee() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/old_employees/edit/' +
                        this.$route.params.rut,
                    {
                        headers: {
                            accept: 'application/json',
        ...
        async getEndDocuments() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/end_documents/edit/' +
                        this.$route.params.rut,
                    {
                        headers: {
                            accept: 'application/json',
