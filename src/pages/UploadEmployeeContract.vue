            ...
            <div class="mt-10">
                <div id="bar-with-underline-1" role="tabpanel" aria-labelledby="bar-with-underline-item-1">
                    <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                        <form @submit.prevent="uploadEmployeeContract">
                            ...
                            <div class="grid md:grid-cols-8 sm:grid-cols-12 gap-4 p-4 md:p-5">
                                ...
                                <router-link
                                    :to="`/labor_data/${$route.params.rut}`"
...
export default {
    ...
    methods: {
        ...
        uploadEmployeeContract() {
            ...
            axios.post('http://localhost:8000/employee_contracts/upload', formData, {
                headers: {
                ...
                localStorage.setItem('uploaded_employee_contract', 1);

                this.$router.push('/labor_data/' + this.$route.params.rut);
            }).catch(error => {
                console.error(error);
                this.loading = false;
            });
