<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Actualizar Principal</h2>

            <div class="mt-3">
                <div
                    v-if="validate_update_principal == 1"
                    class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10"
                    role="alert"
                >
                    Principal Actualizado con <span class="font-bold">éxito</span>
                </div>
                <div
                ...
                >
                    ...
                    >
                        <form @submit.prevent="updatePrincipal">
                            <div
        ...
        async getPrincipal() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/principals/edit/' + this.$route.params.id,
                    {
                        headers: {
                ...
                this.principal_name_input = response.data.message.principal
        ...
        async updatePrincipal() {
            ...
            try {
                ...
                const response = await axios.patch(
                    'http://localhost:8000/principals/update/' +
                ...
                this.validate_update_principal = 1
            } catch (error) {
                console.error(error)
            } finally {
                this.loading = false
