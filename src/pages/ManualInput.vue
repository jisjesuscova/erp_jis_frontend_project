                    ...
                    >
                        <div>
                            ...
                            <hr
                                class="my-12 h-0.5 border-t-0 bg-neutral-100 opacity-100 dark:opacity-50"
                            />
                            <div v-if="employee_loading" class="flex justify-center items-center h-screen">
                                <div role="status">
                                    <!-- SVG spinner -->
                                    <svg
                                        aria-hidden="true"
                            ...
                            <div v-else>
                                <table class="table-auto w-full">
                                    ...
                                    <tbody>
                                        <tr v-for="(payroll_employee, index) in payroll_employees" :key="payroll_employee.id">
                                            <td class="border px-4 py-2">
                                                {{ payroll_employee.visual_rut }}
                                            </td>
                                            <td class="border px-4 py-2">
                                                {{ payroll_employee.names }} {{ payroll_employee.father_lastname }} {{ payroll_employee.mother_lastname }}
                                            </td>
                                            <td class="border px-4 py-2">
                                                <input
                                                type="number"
                                                ...
                                                class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Monto"
                                                v-model="payroll_employees[index].amount_input"
                                                required
                                                />
                                            </td>
                                        </tr>
...
export default {
    ...
    methods: {
        async search() {
            ...
            try {
                alert(this.father_lastname_input)
                const dataToSend = {
                    rut: this.rut_input,
        ...
        async submit() {
            const amounts = this.payroll_employees.map(employee => employee.amount_input);
            console.log(amounts);
        },
