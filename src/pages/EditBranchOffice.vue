<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Actualizar Sucursal</h2>

            <div class="mt-3">
                <div v-if="validate_update_branch_office == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    Sucursal actualizada con <span class="font-bold">éxito</span> 
                </div>
                <div
                        ...
                        <form @submit.prevent="updateBranchOffice">
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        id="branch_office_name_input"
                                        class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Nombre de la sucursal"
                                        v-model="branch_office_name_input"
                                        required
                                    />
                                </div>
                                <div>
                                ...
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Segmento</label>
                                    <select v-model="segment_input"  required class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="">- Segmento -</option>
                                        <option v-for="segment in segments" :key="segment.id" :value="segment.id" >{{ segment.segment }}</option>
                                    </select>
                                </div>
                                
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Zona</label>
                                    <select v-model="zone_input"  required class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Principal</label>
                                    <select v-model="principal_input" required class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="">- Principal -</option>
                                        <option v-for="principal in principals" :key="principal.id" :value="principal.id">{{ principal.principal }}</option>
                                    </select>
                                </div>
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Estado</label>
                                ...
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Visibilidad</label>
                                    <select v-model="visibility_input"  required class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Fecha de apertura</label>
                                    <input
                                        type="date"
                                        id="opening_date_input"
                                        class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Nombre de la sucursal"
                                        v-model="opening_date_input"
                                        required
                                    />
                                </div>
            
                                <div>
                                    <label for="hs-validation-name-error" class="block text-sm font-medium mb-2 dark:text-white">Codigo DTE</label>
                                        <input
                                        type="number"
                                        id="dte_code_input"
                                        class="bg-white-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder=""
                                        v-model="dte_code_input"
                                        required
                                    />
                                </div>
                                <div>
...
export default {
    ...
    data() {
        return {
            ...
            loading_4: false,
            loading_5: false,
            validate_update_branch_office : 0,
            branch_office_name_input: '',
            address_input: '',
            regions: [],
            communes: [],
            segments: [],
    ...
    methods: {
        async getBranchOffice ( ) {
            ...
            try {
                const response = await axios.get('https://apijis.combranch_offices/edit/' + branch_office_id, {
                    headers: {
                ...
                this.branch_office_name_input = response.data.message.branch_office
                ...
                this.segment_input = response.data.message.segment_id
                this.principal_input = response.data.message.principal_id
                this.zone_input = response.data.message.zone_id
                this.status_input = response.data.message.status_id
        ...
        async getSegments() {
            ...
            try {
                const response = await axios.get('https://apijis.comsegments/', {
                    headers: {
                    accept: 'application/json',
                    Authorization: `Bearer ${accessToken}` // Agregar el token al encabezado de la solicitud
                    },
        ...
        async getSupervisors() {
            ...
            try {
                const response = await axios.get('https://apijis.comusers/supervisor' , {
                    headers: {
                    accept: 'application/json',
                    Authorization: `Bearer ${accessToken}` // Agregar el token al encabezado de la solicitud
                    },
        ...
        async getPrincipals() {
            ...
            try {
                const response = await axios.get('https://apijis.comprincipals/', {
                    headers: {
                    accept: 'application/json',
                    Authorization: `Bearer ${accessToken}` // Agregar el token al encabezado de la solicitud
                    },
        ...
        async updateBranchOffice() {
            try{
                ...
                this.loading_1 = true
                const dataToSend = {
                    branch_office: this.branch_office_name_input,
                    address: this.address_input,
                    region_id: this.region_input,
                    commune_id: this.commune_input,
                    segment_id: this.segment_input,
                    zone_id: this.zone_input,
                    principal_id: this.principal_input,
                ...
                const accessToken = localStorage.getItem('accessToken')
                await axios.patch('https://apijis.combranch_offices/update/' +this.$route.params.id, dataToSend, 
                {
                    headers: {
                                accept: 'application/json',
                                Authorization: `Bearer ${accessToken}`, // Agregar el token al encabezado de la solicitud
            ...
            this.validate_update_branch_office = 1
