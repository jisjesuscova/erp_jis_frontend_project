<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Actualizar Banco</h2>

            <div class="mt-3">
                <div
                    v-if="validate_update_bank == 1"
                    class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10"
                    role="alert"
                >
                    Banco Actualizado con <span class="font-bold">éxito</span>
                </div>
                <div
        ...
        async getBank() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/banks/edit/' + this.$route.params.id,
                    {
                        headers: {
                ...
                this.bank_name_input = decodedData.bank
                this.bank_status_input = decodedData.visibility_id
        ...
        async updateBank() {
            ...
            try {
                ...
                const response = await axios.patch(
                    'http://localhost:8000/banks/update/' +
