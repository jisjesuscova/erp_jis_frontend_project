<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Actualizar Isapre</h2>

            <div class="mt-3">
                <div
                    v-if="validate_update_health == 1"
                    class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10"
                    role="alert"
                >
                    Isapre Actualizada con <span class="font-bold">éxito</span>
                </div>
                <div
                ...
                >
                    ...
                    >
                        <form @submit.prevent="updateHealth">
                            <div
        ...
        async getHealth() {
            ...
            try {
                const response = await axios.get(
                    'http://localhost:8000/healths/edit/' + this.$route.params.id,
                    {
                        headers: {
                ...
                this.health_name_input = decodedData.health
        ...
        async updateHealth() {
            ...
            try {
                ...
                const response = await axios.patch(
                    'http://localhost:8000/healths/update/' +
