        ...
        <div v-else class="flex flex-col pt-10">
            ...
            <h2 class="text-4xl dark:text-white pb-10">
                ...
                <router-link
                    v-if="rol_id == 4"
                    href="javascript:;"
                    :to="`/create_medical_license/${this.$route.params.rut}`"
                                    ...
                                    >
                                        ...
                                        >
                                            <router-link
                                                ...
                                                href="javascript:;"
                                                :to="`/upload_medical_license_data_employee/${medical_license.rut}/${medical_license.id}`"
                                            >
                                                <i
...
export default {
    ...
    methods: {
        ...
        async downloadMedicalLicense(id) {
            ...
            try {
                const response = await axios.get(
                    'https://apijis.commedical_licenses/download/' + id,
                    {
                        headers: {
                            accept: 'application/json',
                            Authorization: `Bearer ${accessToken}`, // Agregar el token al encabezado de la solicitud
        ...
        async getMedicalLicenses() {
            ...
            try {
                const response = await axios.get(
                    'https://apijis.commedical_licenses/edit/' +
                        this.$route.params.rut +
                        '/' +
                        page,
                    {
        ...
        async deleteMedicalLicense(id) {
            ...
            try {
                const accessToken = localStorage.getItem('accessToken')
                await axios.delete(
                    `https://apijis.commedical_licenses/delete/${id}`,
                    {
                        headers: {
                            accept: 'application/json',
