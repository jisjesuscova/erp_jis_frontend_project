<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Subir Liquidaciones</h2>

            <div class="mt-3">
                <div
                    v-if="upload_type_input == ''"
                ...
                >
                    ...
                    >
                        ...
                        <form @submit.prevent="createMultipleSalarySettlement">
                            <div
                                class="bg-gray-100 border-b rounded-t-xl py-3 px-4 md:py-4 md:px-5 dark:bg-gray-800 dark:border-gray-700"
                            >
                                <p
...
export default {
    ...
    methods: {
        ...
        async getEmployee() {
            ...
            try {
                const response = await axios.get(
                    'https://apijis.comemployees/select_inputs',
                    {
                        headers: {
        ...
        createMultipleSalarySettlement() {
            this.loading = true;
            ...
            axios
                .post(
                'https://apijis.comsalary_settlements/multiple_store',
                formData,
                {
                    headers: {
                    Authorization: `Bearer ${accessToken}`,
        ...
        createSalarySettlement() {
            ...
            axios
                .post(
                    'https://apijis.comsalary_settlements/store',
                    formData,
                    {
                        headers: {
                            Authorization: `Bearer ${accessToken}`,
