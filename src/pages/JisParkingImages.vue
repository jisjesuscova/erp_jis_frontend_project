<template>
    <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:pl-72">
        ...
        <div v-else class="flex flex-col pt-10">
            <h2 class="text-4xl dark:text-white pb-10">Ingresar Imagen</h2>

            <div class="mt-3">
                <div v-if="validate_create_bank == 1" class="bg-green-500 text-sm text-white rounded-md p-4 mb-10 mt-10" role="alert">
                    Imagen Registrada con  <span class="font-bold">éxito</span> 
                </div>
                <div
...
export default {
    ...
    methods: {
        ...
        async uploadImage() {
            ...
            formData.append('file', this.support)
            try {
                const response = await axios.post(
                    'http://localhost:8000/jis_parking_crud/upload_image',
                    formData,
                    {
                        headers: {
