        ...
        <div v-else class="flex flex-col pt-10">
            ...
            <div class="mt-10">
                ...
                <h2 class="text-4xl dark:text-white pb-10">
                    ...
                    <router-link
                        href="javascript:;"
                        :to="`/create_contract_employee/${this.$route.params.rut}`"
                ...
                <h2 class="text-4xl dark:text-white pb-10">
                    ...
                    <router-link
                        href="javascript:;"
                        :to="`/create_end_contract_employee/${this.$route.params.rut}`"
                        class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
                    >
                        Agregar
                    </router-link>
            ...
            try {
                ...
                if (
                    ...
                    this.job_position_input =
                        response.data.message.job_position_id
                    ...
                    this.entrance_company_input =
                        response.data.message.entrance_company
                    this.entrance_pention_input =
                        response.data.message.entrance_pention
                    this.entrance_health_input =
                        response.data.message.entrance_health
                    ...
                    this.extra_health_amount_input =
                        response.data.message.extra_health_amount
                    this.extra_health_payment_type_input =
                        response.data.message.extra_health_payment_type_id
                    this.apv_payment_type_input =
                        response.data.message.apv_payment_type_id
                ...
                if (error.message == 'Request failed with status code 401') {
                    ...
                    console.error(
                        'Error al obtener los datos laborales del empleado:',
                        error,
                    )
                }
            }
