            ...
            >
                ...
                >
                    <div
                        ...
                        role="alert"
                    >
                        Tienes un periodo de nomina abierto, debes cerrarlo para
                        aperturar uno nuevo.
                    </div>
                    <div>
                        <label
                    ...
                    <div class="grid grid-cols-8 gap-4 p-4 md:p-5">
                        ...
                        <button
                            ...
                            type="button"
                            @click="closePeriod"
                            class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-red-500 text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
                        >
                            Cerrar
        ...
        async closePeriod() {
            ...
            try {
                ...
                const response = await axios.post(
                    'http://localhost:8000/payrolls/close',
                    dataToSend,
                    {
                        headers: {
                            accept: 'application/json',
